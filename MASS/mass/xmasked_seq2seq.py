...
class XMassTranslationTask(FairseqTask):
    ...
    def load_dataset(self, split, **kwargs):
        ...
        for lang_pair in self.args.para_lang_pairs:
            ...
            print('| bilingual {} {}-{}.{}: {} examples'.format(split, src, tgt, src,
                                                                len(src_para_datasets[key + '.' + src])))
            print('| bilingual {} {}-{}.{}: {} examples'.format(split, src, tgt, tgt,
                                                                len(src_para_datasets[key + '.' + tgt])))
